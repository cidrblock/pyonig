...
# Original file: src/ansible_navigator/tm_tokenize/reg.py
# License: Apache-2.0
# Modifications: Changed "import onigurumacffi" to "import pyonig as onigurumacffi"
...
import pyonig as onigurumacffi
...
_FLAGS = {
    # (first_line, boundary)
    (False, False): (
        onigurumacffi.ONIG_OPTION_NOT_END_STRING
        | onigurumacffi.ONIG_OPTION_NOT_BEGIN_STRING
        | onigurumacffi.ONIG_OPTION_NOT_BEGIN_POSITION
    ),
    (False, True): (
        onigurumacffi.ONIG_OPTION_NOT_END_STRING
        | onigurumacffi.ONIG_OPTION_NOT_BEGIN_STRING
    ...
    (True, True): onigurumacffi.ONIG_OPTION_NOT_END_STRING,
}
